...
public class AprobadaParaRendirDB extends EntidadesDB{
    ...
    public static final String Tabla = "AprobadaParaRendirDB";
    ...
    public static final Cursor getQueNecesitoParaFinal(SQLiteDatabase conection,Integer idMateriaTrabada) {
        String sql="";
        String where="";
        sql = "select ";
