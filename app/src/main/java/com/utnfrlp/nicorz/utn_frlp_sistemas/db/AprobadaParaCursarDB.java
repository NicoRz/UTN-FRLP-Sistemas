...
public class AprobadaParaCursarDB extends EntidadesDB{
    ...
    public static final String Tabla = "AprobadaParaCursarDB";
    ...
    public static final Cursor getFinalParaCursar(SQLiteDatabase conection,Integer idMateria) {
        String sql="";
        String where="";
        sql = "select ";
    ...
    public static void LogD(String nombreMetodo,String mensaje) {
        L.LogD("AprobadaParaCursarDB", nombreMetodo + " " + mensaje);
    }
}
